...
function CLC_InitMutationEventsSystem(DOMObj_targ, optionsArray){
   ...
   DOMObj_targ.addEventListener("DOMNodeRemoved", CLC_MutationRemovalHandler, true);
   DOMObj_targ.addEventListener("DOMNodeInserted", CLC_MutationInsertionHandler, true);
   DOMObj_targ.addEventListener("DOMCharacterDataModified", CLC_MutationCharDataModHandler, true);
   }
//------------------------------------------

function CLC_MutationInsertionHandler(event){
   CLC_MutationHandler(event,"insertion");
   }
//------------------------------------------

function CLC_MutationRemovalHandler(event){
   CLC_MutationHandler(event,"removal");
   }
//------------------------------------------

function CLC_MutationCharDataModHandler(event){
   CLC_MutationHandler(event,"change");
   }
...
function CLC_MutationHandler(event,theType){
   var currentEventObj = new CLC_RawMutationEventObj();
   currentEventObj.target = event.target;
   currentEventObj.parentNode = event.target.parentNode;
   ...
   currentEventObj.text = CLC_GetTextContent(event.target);
   ...
   window.setTimeout("CLC_RawMutationEventsProcessor();", CLC_MutationEventsWaitingTime);
   }
//------------------------------------------
